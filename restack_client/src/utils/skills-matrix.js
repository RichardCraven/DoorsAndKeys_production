...
const skillsMatrix = {
    ...
    keen_eye: {
        ...
        tier: 1,
        name: 'Keen Eye',
        desc: 'L1: Reveals nearby traps. L2: +3 DEX to trap saves.',
    ...
    trapper: {
        ...
        tier: 2,
        name: 'Trapper',
        desc: '25% chance to negate any trap entirely.',
    ...
    shadow_curse: {
        ...
        tier: 3,
        name: 'Shadow Curse',
        desc: 'Curse the target for 4 rounds. While active, the stamina (endurance) cost of any movement or action is tripled (increased from 2 to 6). If stamina drops to 0, the unit is immediately exhausted, falling asleep and becoming stunned for 3 rounds.',
