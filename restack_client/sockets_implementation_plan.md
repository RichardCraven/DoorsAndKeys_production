...
### 4.3 Backend Code Skeletal Setup (`index.js` & `sockets/socketManager.js`)

#### `restack_backend/sockets/socketManager.js`
```javascript
...
### 5.3 Frontend Socket Singleton (`src/utils/socket-handler.js`)
```javascript
